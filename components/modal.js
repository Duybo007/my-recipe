...
function Modal() {
    ...
    const uploadPost = async () =>{
        if(loading) return; //prevent users from keep clicking
        setLoading(true)
    ...
    <Transition.Root show={open} as={Fragment}>
        ...
        >
            <div className='flex items-end justify-center min-h-[800px] sm:min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0'>
                ...
                leaveTo="opacity-0 translate-y-4 sm:stranlate-y-0 sm:scale-95"
                >
                        ...
                        <div>
                            ...
                            <div>
                                <div className='mt-3 text-center sm:mt-5'>
                                    <Dialog.Title
                                    as="h3"
                                    className="text-lg leading-6 font-demium text-gray-900">
                                        Upload a photo
                                    </Dialog.Title>
                                    <div>
                                        <input
